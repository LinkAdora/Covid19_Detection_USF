...
#read in data
dataset = read.spss("R:\\Research\\Res_sensor_paper\\combined_metadata.sav", to.data.frame=TRUE)
#view data
# View(dataset)
...
pmean_outcome = dataset$Prominence_mean
...
y_trt<-matched$Prominence_mean[matched$COVID_state==1]
y_con<-matched$Prominence_mean[matched$COVID_state==0]
